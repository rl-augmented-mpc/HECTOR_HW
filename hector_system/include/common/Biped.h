  ...
  public:
    void setBiped(int real_flag = 1){ // 1 for Real, 0 for Sim
        ...
        if (real_flag == 0)
        {
            ...
            int temp_sequence[] = {1, 2, 9, 10, 11, 4, 5, 6, 7, 8};
            for (int i = 0; i < 10; ++i) {
                motor_sequence[i] = temp_sequence[i];
            }
            ...
            // lt = 0.07; //lt is length of a vector from ankle to toe and lh is to heel
            // lh = 0.04;
            // lw = 0.04;
            // lt = 0.1;
            // lh = 0.07; 
            ...
            //TODO: Check the usages of these variables
    ...
    //robot dynamics
    double mass;
    Eigen::Matrix<double,3,3> I_body;
